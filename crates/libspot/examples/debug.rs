//! Debug example to find divergence point between implementations
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Run smaller tests at different scales
    let test_sizes = [1000, 10000, 100000, 500000, 1000000];
    ...
    for &k in &test_sizes {
        ...
        println!("k={}: ANOMALY={} EXCESS={} NORMAL={} Z={:.6} T={:.6}", 
                 k, anomaly, excess, normal,
